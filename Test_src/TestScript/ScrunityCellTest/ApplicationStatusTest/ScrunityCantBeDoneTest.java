...
import Pages.ScrunityCell.ApplicationStatus.ScrunityCantBeDone;
 ...
 */
public class ScrunityCantBeDoneTest {
    ...
    public static ScrunityCantBeDone scrunityCantBeDone;
    ...
    public  void OutputExcelCreation() throws IOException, BiffException, WriteException {
        ...
        copyDocument = Workbook.createWorkbook(new File("ExcelData/TestReport/ScrunityReports/ScunityCnatbeDoneTestReport.xls"));
        sourceSheet = writableTempSource.getSheet(14);
...
/*-----------------------------------------------------------------------------------------------------------------------*/
                ...
                Label lable = new Label (0, 0,
                        "Scunity Can't be Done",cellFormat5);
    ...
    public static void SCBD_Test(String testcaseName,String keyword,String objectName,String value,String Expected) throws Exception {
        ...
        if (testcaseName != null && testcaseName.length() != 0 ) {
           ...
           // sc_menu.setApplicationTab();
            Thread.sleep(150);
            sc_menu.setScrutiny_Not_Done();
            scrunityCantBeDone =new ScrunityCantBeDone(driver);
                ...
                case "SETTEXT":
                    ...
                    switch (objectName) {
                        ...
                        case "Enter Keyword for search":
                            ...
                            actions.moveToElement(scrunityCantBeDone.getSeachWithKeyword());
                            actions.click();
                            actions.click();
                        ...
                        case "Get Proposal Status":
                            ...
                            try {
                                ...
                                if(scrunityCantBeDone.getProposalStatus().getText().equals(value))
                                {   System.out.println("don");
                                    //driver.switchTo().frame("ifrmToolbar");
                                    Result="pass"; driver.close();
                                }else {
                                    Actual=scrunityCantBeDone.getProposalStatus().getText();
                                    Result="fail"; driver.close();
                                }


                            }catch (Throwable e)
                            {
                                System.out.println(e.getMessage()); driver.close();
                            }
                            break;
