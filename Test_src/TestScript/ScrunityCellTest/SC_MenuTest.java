package TestScript.ScrunityCellTest;
...
/*-----------------------------------------------------------------------------------------------------------------------*/
    ...
    public static void ScrunityCellTest(String testcaseName, String keyword, String objectName, String value, String Expected) throws Exception {
        ...
        if (testcaseName != null && testcaseName.length() != 0) {
            ...
            sc_menu.setConversionDone();
            sc_menu.setScrunityPending();
            Thread.sleep(30000);
            sc_menu.setScrunityDone();
            sc_menu.setConversionP_Resubmitted();
            sc_menu.setConversionP_30000();
            sc_menu.setDashboardTab();
            Thread.sleep(30000);
            sc_menu.setDashboard();
