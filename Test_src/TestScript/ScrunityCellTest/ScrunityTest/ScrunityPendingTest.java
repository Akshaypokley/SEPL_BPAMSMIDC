 ...
 */
public class ScrunityPendingTest {
    ...
    public static ScrunityPending scrunityPending;
    ...
    public  void OutputExcelCreation() throws IOException, BiffException, WriteException {
        ...
        copyDocument = Workbook.createWorkbook(new File("ExcelData/TestReport/ScrunityReports/ScrunityPedingTestReport.xls"));
...
/*-----------------------------------------------------------------------------------------------------------------------*/
    ...
    public static void SPTest(String testcaseName,String keyword,String objectName,String value,String Expected) throws Exception {
        ...
        if (testcaseName != null && testcaseName.length() != 0 ) {
            ...
            Thread.sleep(150);
            sc_menu.setScrunityPending();
            scrunityPending =new ScrunityPending(driver);
                    ...
                    switch (objectName) {
                        ...
                        case "Change Status":
                            ...
                            try {
                                ...
                                scrunityPending.setChange_Status();
                                Result = "pass";
                            } catch (Throwable e) {
                ...
                case "SETTEXT":
                    ...
                    switch (objectName) {
                        ...
                        case "Enter Keyword for search":
                            ...
                            actions.moveToElement(scrunityPending.getSeachWithKeyword());
                            actions.click();
                            actions.click();
                        ...
                        case "Get Proposal Status":
                            ...
                            try {
                                ...
                                if(scrunityPending.getProposalStatus().getText().equals(value))
