package TestScript.SPA_Test.SubmissionTest;

import Pages.SPA_ConsoleActivity.Application_Submission.Submitted_Application;
...
public class SubmittedApplicationTest {
    ...
    public static Submitted_Application submitted_application;
    ...
    public  void OutputExcelCreation() throws IOException, BiffException, WriteException {
        ...
        copyDocument = Workbook.createWorkbook(new File("ExcelData/TestReport/SPAReports/SubmittedApplicationTestReport.xls"));
...
/*-----------------------------------------------------------------------------------------------------------------------*/
                ...
                Label lable = new Label (0, 0,
                        "Scrunity Peding screen test  report",cellFormat5);
    ...
    public static void SPTest(String testcaseName,String keyword,String objectName,String value,String Expected) throws Exception {
        ...
        if (testcaseName != null && testcaseName.length() != 0 ) {
            ...
            submitted_application =new Submitted_Application(driver);
                    ...
                    switch (objectName) {
                        ...
                        case "Select Status":
                            ...
                            try {
                             ...
                             //   scrunityPending.setselectStatus(value);
                        ...
                        case "Remarks Details":
                            ...
                            try {
                              ...
                              //  scrunityPending.setRemarks(value);
                        ...
                        case "Enter Keyword for search":
                            ...
                            actions.moveToElement(submitted_application.getSeachWithKeyword());
                            actions.click();
                            actions.click();
                        ...
                        case "Get Proposal Status":
                            ...
                            try {
                                ...
                                if(submitted_application.getProposalStatus().getText().equals(value))
                        ...
                        case "Select Architct":
                            ...
                            Thread.sleep(2000);
                            /*submitted_application.setSelect_ArchitectName(value);
                            submitted_application.ClickSeachBtn();
                           */ Thread.sleep(200);
                            Result = "pass";
