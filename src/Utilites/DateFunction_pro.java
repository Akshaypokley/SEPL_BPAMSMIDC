 ...
 */
public class DateFunction_pro {

 static WebDriver driver;
    public static void DateFunpro(WebDriver driver, String seDate) throws ParseException, InterruptedException

    {
        ...
        Date curDate = calDateFormat.parse(driver.findElement(By.className("rcTitle")).getText());
        Thread.sleep(1000);
...
// iterate through month difference
        for(int i=1;i<=monthDiff;i++){
            ...
            driver.findElement(By.xpath("//html/body/div[1]/div[4]/table/thead/tr/td/table/tbody/tr/td/a[@class="+ (isFuture ? "'rcNext'" : "'rcPrev'") + "]")).click();
        }
// Click on Day of Month from table
        driver.findElement(By.xpath("//html/body/div[1]/div[4]/table/tbody/tr/td/table/tbody/tr/td/a[text()='" + (new DateTime(setDate).getDayOfMonth()) + "']")).click();
